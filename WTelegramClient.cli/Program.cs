...
namespace WTelegramClient.cli
{
	static class Program_GetAllChats
	{
		...
		{
			if (what == "api_id") return "8822807";// Environment.GetEnvironmentVariable("api_id");
			if (what == "api_hash") return "d6e4622794228d0d48700401c0a2cf3c";// Environment.GetEnvironmentVariable("api_hash");
			if (what == "phone_number") return "+8613286632789";// Environment.GetEnvironmentVariable("phone_number");
